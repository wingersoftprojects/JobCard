...
public class Group_detail implements Serializable {
	...
	public static Group_detail loadGroup_detailByORMID(PersistentSession session, int group_detail_id) throws PersistentException {
		try {
			return (Group_detail) session.load(models.Group_detail.class, new Integer(group_detail_id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Group_detail getGroup_detailByORMID(PersistentSession session, int group_detail_id) throws PersistentException {
		try {
			return (Group_detail) session.get(models.Group_detail.class, new Integer(group_detail_id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Group_detail loadGroup_detailByORMID(PersistentSession session, int group_detail_id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Group_detail) session.load(models.Group_detail.class, new Integer(group_detail_id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Group_detail getGroup_detailByORMID(PersistentSession session, int group_detail_id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Group_detail) session.get(models.Group_detail.class, new Integer(group_detail_id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryGroup_detail(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From models.Group_detail as Group_detail");
		if (condition != null)
	...
	public static Group_detail createGroup_detail() {
		return new models.Group_detail();
	}
	...
	@Id	
	@GeneratedValue(generator="MODELS_GROUP_DETAIL_GROUP_DETAIL_ID_GENERATOR")	
	@org.hibernate.annotations.GenericGenerator(name="MODELS_GROUP_DETAIL_GROUP_DETAIL_ID_GENERATOR", strategy="native")	
